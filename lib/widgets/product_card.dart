...
import 'package:football_collectibles/screens/login.dart';
...
class ItemHomepage {
  ...
  ItemHomepage({required this.name, required this.icon, required this.color});
}
        ...
        onTap: () async {
          ...
          if (item.name == "All Products") {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    const ProductEntryList(filterByUser: false),
              ),
            );
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    const ProductEntryList(filterByUser: true),
              ),
            );
